...
\begin{document}
	...
	Założenia projektowe obejmują zaprojektowanie sieci lokalnej z dostępem do Internetu. Dwa budynki urzędu połączone są ze sobą kablem światłowodowym jednomodowym, który jest wystarczający na zapewnienie przepustowości wymaganej przez budynek 2 (IDF2). Punkt pośredni IDF1 zostanie podłączony kablem gigabitowym. Serwery WWW oraz FTP umieszczone zostaną w DMZ podłączonej do Głównego Punktu Dystrybucyjnego (MDF). MDF posiada główne i jedyne podłączenie urzędu do Internetu. Do podłączenia pojedynczych stacji roboczych wystarczą kable Ethernetowe o przepustowości 10 Mb/s (cat 3), które zgodnie z wymaganiami są wystarczające, aczkolwiek zgodnie ze współczesnym standardem w nowych instalacjach montuje się kable zgodne z cat 5e lub cat 6, więc zalecany jest montaż kabli 100 Mb/s. Switche połączone będą ze sobą kablami 1 Gb/s. Minimalna wymagana prędkość łącza internetowego wynosi 54,08 Mb/s dla downloadu oraz 31,6 Mb/s uploadu.
